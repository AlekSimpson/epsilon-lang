...
TDO_correct = BinOpNode(NumberNode(Token(NUMBER, Type(NUMBER), "1")), 
                         Token(ADD, "+"), 
                         BinOpNode(NumberNode(Token(NUMBER, Type(NUMBER), "2")), 
                                   Token(MULT, "*"), 
                                   NumberNode(Token(NUMBER, Type(NUMBER), "4"))))
...
exp_op_correct = BinOpNode(NumberNode(Token(NUMBER, Type(NUMBER), "1")), Token(EXPONENT, "^"), NumberNode(Token(NUMBER, Type(NUMBER), "2")))
...
var_dec_correct = VarDecNode(Token(NUMBER, Type(NUMBER), "test"), NumberNode(Token(NUMBER, Type(NUMBER), "5")))
...
bool_true_correct = BoolNode(Token(BOOL, Type(BOOL), "true"))
bool_false_correct = BoolNode(Token(BOOL, Type(BOOL), "false"))
...
unary_test = ParserTest("Unary Node",
                        [Token(NOT, "!"), Token(BOOL, Type(BOOL), "true")],
                         UnaryNode(Token(NOT, "!"), BoolNode(Token(BOOL, Type(BOOL), "true"))))
